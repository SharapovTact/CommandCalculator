...
int main(int argc, char **argv)
{
    ...
    work_m_00000000002194260708_0551501700_init();
    work_m_00000000001976880520_1577989384_init();
    ...
    work_a_2382061112_3212880686_init();


    xsi_register_tops("work_a_2382061112_3212880686");
